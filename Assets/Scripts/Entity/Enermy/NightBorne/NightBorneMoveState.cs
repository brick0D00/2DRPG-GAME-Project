...
public class NightBorneMoveState : NightBorneState
{
    public NightBorneMoveState(Enermy_NightBorne _enermy, EnermyStateMachine _stateMachine, string _aniBoolName) : base(_enermy, _stateMachine, _aniBoolName)
    {
    }
