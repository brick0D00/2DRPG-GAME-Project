...
public class SkeletonWaitAttackState : SkeletonState
{
    private Transform player;
    public SkeletonWaitAttackState(Enermy_Skeleton _enermy, EnermyStateMachine _stateMachine, string _aniBoolName) : base(_enermy, _stateMachine, _aniBoolName)
    {
    }
